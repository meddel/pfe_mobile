...
public class AjoutBusDialog extends Dialog {
    ...
    public AjoutBusDialog(@NonNull final Context context) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                addNewBus((MainActivity) context);
            }
        });
    ...
    private void addNewBus(@NonNull MainActivity context) {
        ...
        context.ajouterBus(true,numEmat,typeBus,marqBus,dateFabBus,dateMiseServ);
    }
